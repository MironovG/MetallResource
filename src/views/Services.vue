<template>
    ...
    <div class="col-12">
      <div class="d-flex align-items-center justify-content-center gap-2">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="25" fill="currentColor" class="bi bi-sliders"
             viewBox="0 0 16 16" stroke="#0d6efd">
  ...
  <div v-show="store.isSomeSelected" class="row">
    <div id="selectResult" class="col-md-10 col-12"></div>
  ...
  <teleport defer to="#selectResult" :disabled="!store.isSomeSelected">
    <div class="row row-cols-1 row-cols-md-2 gy-4">
      <div v-for="(service, index) in store.services"
           :key="index"
           class="col">
        <div :class="['h-100 service-card cursor-pointer d-flex flex-column flex-md-row align-items-center gap-5 bg-light p-4 border rounded-3',
